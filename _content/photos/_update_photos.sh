...
do
    ...
    exif=$(exiftool "$f" -S -Title -FileSize -Software -UserComment -Description -ImageWidth -ImageHeight -Make -Model -LensInfo -ExposureTime -ISO -ExposureCompensation -Flash -Keywords -DateTimeOriginal -d "%Y-%m-%d %H:%M:%S")
